...
type
  Tdm = class(TDataModule)
    ...
    query_detalhes_pro_os: TFDQuery;
    DSdetalhes_pro_os: TDataSource;
    ...
    query_detalhes_pro_osid: TFDAutoIncField;
    query_detalhes_pro_osid_os: TIntegerField;
    query_detalhes_pro_osid_item: TIntegerField;
    query_detalhes_pro_ositem_descricao: TStringField;
    query_detalhes_pro_ositem_tipo: TStringField;
    query_detalhes_pro_osvalor: TBCDField;
    query_detalhes_pro_osquantidade: TBCDField;
    query_detalhes_pro_ostotal: TBCDField;
    query_detalhes_pro_osfuncionario: TStringField;
    query_detalhes_pro_osdata: TDateField;
    query_detalhes_serv_os: TFDQuery;
    ...
    DSdetalhes_serv_os: TDataSource;
    query_detalhesOSCoringa: TFDQuery;
    ...
    tb_osid: TFDAutoIncField;
    query_osid: TFDAutoIncField;
    ...
    DSOrdens_Serv: TfrxDBDataset;
    DSdetalhes_pro_Ordem: TfrxDBDataset;
    DSdetalhes_serv_ordem: TfrxDBDataset;
    rel_OS: TfrxReport;
...
var
  ...
  idServ, chamadaBuscarServ, chamadaServOSVADD, idServico, chamadaProdOSVADD : string;
  frmVen : string;
  idFunc : string;
  nomeFunc : string;
  cargoFunc : string;
  ...
  chamadaProdPDV, janelaProdutoOS : string;
  ...
  idProduto : string;
  chamadaprodOS, chamadaservOS : string;
  janelacancelariten : string;
  janelaprodutos : string;


  totalProdutos, totalitempro, totalitemserv: double;
  ...
  totalVenda, totalVendaServ, totalCompra: double;
...
valorTotalFechamento : Double;
 ...
 chamadaClidOS, telefoneCliente, enderecoCliente : string;
 janelaCliente, janelaServicos : string;

totalOS, trocoOs, ValorRecebidoOs, descontoOS : double;
