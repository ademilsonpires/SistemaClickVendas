object FrmContasReceber: TFrmContasReceber
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object BtnFinalizarDuplicata: TSpeedButton
    Left = 315
    Top = 478
    Width = 181
    Height = 42
    Cursor = crHandPoint
    Caption = 'Finalizar Duplicata'
    Enabled = False
    Flat = True
    ...
    ParentFont = False
    OnClick = BtnFinalizarDuplicataClick
  end
  ...
  object cbduplicata: TComboBox
    Left = 256
    Top = 168
    Width = 105
    Height = 21
    TabOrder = 3
    OnChange = cbduplicataChange
    Items.Strings = (
      'a vencer'
      'vencidas')
  end
  object rbemissao: TRadioButton
    ...
    ParentFont = False
    TabOrder = 4
    OnClick = rbemissaoClick
  end
  object rbvencimento: TRadioButton
    Left = 419
    Top = 163
    Width = 124
    Height = 21
