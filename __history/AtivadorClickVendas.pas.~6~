...
type
  ...
  public
    { Public declarations }
    numeroInstalacao, serialkeyInstalado:string;
  end;
...
if  edtID.Text <> ''  then
   begin
     ...
     serialkeyInstalado := Crypt('C',numeroInstalacao);
...
begin
ativacao;
edtSeriallicenca.Text := serialkeyInstalado;
